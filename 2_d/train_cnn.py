...
for trial in range(NUM_TRIALS):
    ...
    with tf.Session() as sess:
        ...
        print("{:^5} {:^5} {:^10} {:^10} {:^8}".format('Trial','Step', 'Reward', 'Ideal', 'Regret'))
        print("-" * 41)
        ...
        for i in range(TRAINING_STEPS):
            ...
            if not i % INTERVAL:
                ...
                regret[i // INTERVAL] /= 5
                print_list = [trial, i, rewards / 5, ideal / 5, regret[i // INTERVAL][0]]
                print("{:5} {:5} {:10.5} {:10.5} {:8.5}".format(*print_list))
